...
DROP POLICY IF EXISTS "Users can view metrics for their own plants";
...
DROP POLICY IF EXISTS "Users can insert metrics for their own plants";
...
DROP POLICY IF EXISTS "Users can view their own recipes";
CREATE POLICY "Users can view their own recipes"
  ON recipes FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own recipes";
...
DROP POLICY IF EXISTS "Anyone can view suggested items";
CREATE POLICY "Anyone can view suggested items"
  ON suggested_items FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Only admins can insert suggested items";
...
DROP POLICY IF EXISTS "Only admins can update suggested items";
...
DROP POLICY IF EXISTS "Only admins can delete suggested items";
...
DROP POLICY IF EXISTS "Admins can view all plants";
...
DROP POLICY IF EXISTS "Admins can view all plant metrics";
