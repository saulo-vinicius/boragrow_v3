...
interface PremiumSubstance extends Substance {
  premium: boolean;
  brand: string;
}
...
const BoraGrowCalculator = () => {
  ...
  const [customSubstanceDialogOpen, setCustomSubstanceDialogOpen] =
    useState<boolean>(false);
  const [editingSubstance, setEditingSubstance] = useState<Substance | null>(
    null,
  );
  const [saveRecipeDialogOpen, setSaveRecipeDialogOpen] =
    useState<boolean>(false);
  const [recipeName, setRecipeName] = useState<string>("");
  const [recipeDescription, setRecipeDescription] = useState<string>("");
  const [savedRecipes, setSavedRecipes] = useState<any[]>([]);
  const [savedRecipesDialogOpen, setSavedRecipesDialogOpen] =
    useState<boolean>(false);
  ...
  const [customSubstanceFormula, setCustomSubstanceFormula] =
    useState<string>("");
  const [customSubstanceElements, setCustomSubstanceElements] = useState<
  ...
  const [premiumSubstances, setPremiumSubstances] = useState<
    PremiumSubstance[]
  >([]);
  const [isPremiumLoading, setIsPremiumLoading] = useState<boolean>(false);
  const [searchResults, setSearchResults] = useState<
    (Substance | PremiumSubstance)[]
  >([]);
  const searchInputRef = useRef<HTMLInputElement>(null);

  // Mock premium substances for demo
  const mockPremiumSubstances: PremiumSubstance[] = [
    {
      id: "advanced-micro",
    ...
    },
    {
      ...
      formula: "",
      elements: { "N (NO3-)": 3.0, "N (NH4+)": 2.0, K: 3.0, Mg: 1.5 },
      premium: true,
      brand: "Advanced Nutrients",
    },
    {
      ...
      formula: "",
      elements: { "N (NO3-)": 1.0, "N (NH4+)": 1.0, P: 4.0, K: 5.0 },
      premium: true,
      brand: "Advanced Nutrients",
    },
    {
      id: "plant-prod-veg",
      name: "Plant-Prod MJ Veg",
      formula: "",
      elements: {
        "N (NO3-)": 12.0,
        "N (NH4+)": 8.0,
    ...
    {
      id: "plant-prod-finisher",
      name: "Plant-Prod MJ Finisher",
      formula: "",
      elements: {
        "N (NO3-)": 4.0,
        "N (NH4+)": 0.0,
    ...
    {
      id: "greenhas-kinglife",
      name: "Greenhas Kinglife 20-20-20",
      formula: "",
      elements: { "N (NO3-)": 20.0, P: 20.0, K: 20.0 },
      premium: true,
      brand: "Greenhas",
    },
  ];
      ...
      if (editingSubstance) {
        ...
        const updatedSelected = selectedSubstances.map((s) =>
          s.id === editingSubstance.id
            ? { ...newSubstance, weight: s.weight }
            : s,
        );
        setSelectedSubstances(updatedSelected);

        // Update in custom substances list
        setUserCustomSubstances((prev) =>
          prev.map((s) => (s.id === editingSubstance.id ? newSubstance : s)),
        );
      } else {
        // Add to custom substances
        setUserCustomSubstances((prev) => [...prev, newSubstance]);
      }

      setCustomSubstanceDialogOpen(false);
      alert("Substance saved successfully");
    } catch (error: any) {
      console.error("Error saving substance:", error);
      alert("Failed to save substance");
    }
  };
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    if (
                                      ...
                                      alert(
                                        `Substance "${substance.name}" deleted successfully`,
                                      );
                                    }
                                  }}
                                >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        alert("All target concentrations have been cleared");
                      }}
                    >
                      Clear Values
                    </Button>
                  ...
                  <div className="flex gap-2 mt-4">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        alert("Target concentrations set for vegetative stage");
                      }}
                    >
                      Veg
                    </Button>
                    <Button
                      ...
                      onClick={() => {
                        ...
                        alert("Target concentrations set for flowering stage");
                      }}
                    >
                      Flowering
                    </Button>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              ...
              onClick={() => {
                setSelectedSubstances([]);
                setResults(null);
                alert("All selections and results have been cleared");
              }}
            >
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        alert("Recipe has been exported as CSV");
                      }}
                    >
                      Export Recipe (CSV)
                    </Button>
                    <Button
                      ...
                      onClick={() => {
                        ...
                        navigator.clipboard.writeText(textContent).then(
                          () => {
                            alert("Recipe has been copied to clipboard");
                          },
                          (err) => {
            ...
            <Button
              onClick={() => {
                if (!recipeName.trim() || !results) {
                  alert("Please provide a name for your recipe");
                  return;
                }
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            alert(
                              `${recipe.name} has been loaded into the calculator`,
                            );
